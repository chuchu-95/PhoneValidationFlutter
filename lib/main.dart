          ...
          children: [
            BlocBuilder<PhoneNumberBloc, PhoneNumberState>(
              builder: (context, state) {
                return TextField(
                  onChanged: (value) {
                    context.read<PhoneNumberBloc>().add(PhoneNumberChanged(value));
                  },
                  decoration: InputDecoration(
                    labelText: 'Phone Number',
                    errorText: state.isValid ? null : 'Invalid phone number',
                  ),
                );
              },
            ),
            ...
            ElevatedButton(
              onPressed: () {
                context.read<PhoneNumberBloc>().add(ValidatePhoneNumber());
              },
              child: Text('Validate'),
            ),
          ],
